...
const buttonStyles: any = {
  ...
  theme: {
    button:
      "ring-2 gap-2 rounded-3xl ring-2 py-3 px-8 bg-black text-white ring-black hover:bg-gray-500 hover:text-white hover:ring-gray-500  dark:bg-gray-100 dark:text-gray-800 dark:ring-gray-100 dark:hover:text-white dark:hover:bg-gray-700 dark:hover:ring-gray-700",
    outline:
    ...
    link: "bg-transparent border-0 ring-0 text-current hover:text-back dark:hover:text-white hover:underline",
  },
};
